...
const MODULOS: { key: string; label: string; desc: string; uso: string }[] = [
  ...
  { key: "alertas", label: "Alertas y mensajes", desc: "Centro de avisos del sistema, recordatorios de ARCA y del mes, y mensajes internos del equipo.", uso: "Revisá los vencimientos, marcá como hecho cada recordatorio del mes y dejale mensajes al resto del equipo." },
  ...
  { key: "productos", label: "Productos", desc: "Catálogo de productos y servicios con unidad de medida, precio y categoría.", uso: "Cargá o editá productos y servicios (gasoil, silo bolsa, picado, embolsado, traslados, cotizaciones) para usarlos en facturas y presupuestos." },
