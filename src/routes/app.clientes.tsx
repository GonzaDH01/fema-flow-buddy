...
function ClientesPage() {
  ...
  const [form, setForm] = useState({ nombre: "", email: "", telefono: "", empresa: "", direccion: "", notas: "" });
  ...
  const create = useMutation({
    ...
    onSuccess: () => {
      ...
      setForm({ nombre: "", email: "", telefono: "", empresa: "", direccion: "", notas: "" });
      setOpen(false);
    ...
    <div className="p-8">
      <header className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Gestiona tu cartera de clientes FEMA.</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-dashed border-border bg-card p-16 text-center">
          <p className="text-muted-foreground">Aún no hay clientes registrados.</p>
